...
dtt: Moved to PatchExitToShell.c
...
void	StartNoise()
{
	...
	SoundBuf=(FFSynthPtr)ZNewPtr(700);	/*	Allocate buffer					*/
...
SndDoubleBuffer	*SKCreateDBuffer()
{
	...
	buf=(SndDoubleBuffer *)ZNewPtr(SKBUFFERSIZE+sizeof(SndDoubleBuffer));
